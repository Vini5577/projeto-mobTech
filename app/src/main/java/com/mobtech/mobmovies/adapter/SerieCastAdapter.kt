...
import com.mobtech.mobmovies.data.TvCast

class SerieCastAdapter(private val tvCast: List<TvCast>, private val context: Context, private val listener: OnItemClickListener) {
